...
use crate::alignment::{AlignmentOperation, PairwiseAlignment};
...
// Traceback moves
const TB_START: u32 = 0b0000;
const TB_INS: u32 = 0b0001;
const TB_DEL: u32 = 0b0010;
const TB_SUBST: u32 = 0b0011;
const TB_MATCH: u32 = 0b0100;

const TB_XCLIP_PREFIX: u32 = 0b0101; // prefix clip of x
const TB_XCLIP_SUFFIX: u32 = 0b0110; // suffix clip of x
const TB_YCLIP_PREFIX: u32 = 0b0111; // prefix clip of y
const TB_YCLIP_SUFFIX: u32 = 0b1000; // suffix clip of y

const TB_MAX: u32 = 0b1000; // Useful in checking that the
