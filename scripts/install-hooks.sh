#!/bin/bash
#
# Install git hooks for stitch development
#
...
echo "Installing git hooks for stitch..."

# Verify we're in the right place
if [[ ! -f "${REPO_ROOT}/Cargo.toml" ]]; then
    echo "Error: Must be run from the stitch repository"
    exit 1
fi
...
echo "  STITCH_PRECOMMIT_TEST=1 git commit"
echo ""
